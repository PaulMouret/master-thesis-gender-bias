...
#If needed, can use DAMA notebook_utils.py
...
def heatmap(data, row_labels, col_labels, title, ax=None,
    ...
    **kwargs
    ...
    #ax.set_xticks(np.arange(data.shape[1]), labels=col_labels) #If we wanted col_labels
    ...
    #ax.set_xticks(np.arange(data.shape[1]+1)-.5, minor=True) #if we wanted col labels
